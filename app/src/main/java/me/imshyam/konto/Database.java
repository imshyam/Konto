...
public class Database {
    ...
    private static final String DATABASE_TABLE1="Table_1";
    private static final String DATABASE_TABLE2="Table_2";
    private static final String DATABASE_TABLE3="Table_3";
