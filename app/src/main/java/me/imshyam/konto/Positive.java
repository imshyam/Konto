...
public class Positive extends Activity{
    ...
    public static String error1="No Network.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll=(TableLayout)findViewById(R.id.table1);
        new GetAll().execute();
    }
    ...
    class GetAll extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Positive.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(Tag_Status==1) {
                try {
                    String Str = json.getString("positive_name");
                    Str = Str.replace("\"", "");
                    Str = Str.replace("[", "");
                    Str = Str.replace("]", "");
                    String[] list = Str.split(",");

                    String Details = json.getString("positive");
                    ...
                    for (int i = 0; i < list.length; i++) {
                        ...
                        btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                AccId=listDetail[finalI *4+0];
                                Dicision="Delete";
                                new DeleNoti().execute();
                            }
                        });
     ...
     * Background Async Task to add Notifications
     * */
    class DeleNoti extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            // Building Parameters
            HttpPost httpPost = new HttpPost(url_delNot);
            DefaultHttpClient httpClient = new DefaultHttpClient();
            ...
            try {
                jGroup.put("account_id", AccId);
                jGroup.put("decision", Dicision);
            } catch (JSONException e) {
                e.printStackTrace();
            }
